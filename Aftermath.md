...
The assumption is that the most advanced content placement techniques ('content marketing') are used in advertising networks by the likes of Google, Outbrain and Facebook. These companies lever multiple sources of personal information to target ads to end users using multiple and deep data sources such as Experian and their own big data stores. This targeting is both used to serve ads (Google Ad Network) and present users with content that is more likely to result in them clicking ads (facebook, Outbrain). Effectively there is no distinction between ads and content; they are treated the same, compationally speaking.

The amount of effort and intelligence used to create the mechanisms of deep data that power these are immense, it is not an exageration to say that the technical pinnacle of online programming is the serving of ads.

Deep data is driven by Graph technologies. These store entites in loose and complex structures which can be added to and reconfigured on the fly. Unlike static data where the central descriptor is a 'keyed' node (a static property of a node) and where complexity rapidly introduces labyrynthine complexity, graph data is structured by relations. Graph data sits behind the friend of a friend and other complex content recommendation algorhythms that drive a platform like Netflix. Again it is no exageration to say that the social web simply isn't possible without a Graph approach. 

Graph data is expressed in decriptive and active language; (Mary) - [friend] -> (Ben). Mary is a friend to Ben. This allows for poetic assemblages of data; you could say; Mary - [shades] -> Ben. Or; The Moon - [lives] in - The Ocean. To return information we aren't using SQL (essentially set theory) to find 'matches' across a whole database, instead we traverse a data structure, beginning at an arbitary point. To use a more philosophical comparator SQL data is all about categories and definitions of what is (rational, static structures of knowledge) where Graph is more about dynamic relations of what could be; more akin to The Rhizomatic.

2. New narratives - the rise of the long-form, complex and hybrid narrative structures.

Paralell to this we have seen a surge in the use of complex narratives in long-form work that spans fiction and non-fiction. The three-act structure is a useful tool in the arsenal for these succesful works but it's only one tool of many. Mystery and tone are just as likely to create a great work as driving narrative (24, Homeland). Madmen is the classic case in point here - the dramatic questions of the first couple of series around Donald's past are simply abandoned and no one seemed to mind as long as the tone was right and interetsing people came in. Madmen breaks many rules; We never get a conclusion about Donalds moral worth for instance, and somewhere along the way Peggy becomes more interesting. Madmen also has episodes that about nothing in particular in terms of dramatic action - tonal episodes that don't advance the story but shine a light on a character. This is narrative as fractal or facet rather than completed or conclusive.

We have also become used to non-fiction where the writer explicity sits inside the work and uses the act of writing to further articulate the work of non-fiction. Here we get the work of authors like XXX who, in HHH, writes about an assisinatin attepmt on Heinreich Himmler from a distinctly personal point of view. This makes a series of historic events significantly more interesting, and we get things like podcats where the investigator is unsure of the outcome of the narrative as they are producing it.

While it is tempting to think that culture has 'grown up' in the sense that TV is now commonly emplying ideas and techniques that were previously avant-garde, it is probably more accurate to say that narrative is more complex because digital long-form content is a better platform for loyalty and therefore advertising. Star Wars is a case in point here - the first (or fourth) movie on 1977 was expliticty written from the three-act form using Joesph Campbells 'call to action' archetypes. The Star Wars Narrative Universe has long-since moved into a multi-strand narrative that is probably too complex for anyone to actually comprehend in one lifetime without developing mental health issues. The recent Rebel One movie took a single moment from the 1977 movie and asked 'how did that get to be there?'.

While the creation of fans/consumers is the explicit call of the current practice of online content marketing it has, the creation of the fan has always been important. Printed serials, long-running soaps and even sporting events like the Tour De France, are all about suspended narrative arcs where dramatic action is held back for very long periods of time. Content creators have mined this area of story and commerce for centuries. Perhaps it is more accurate to say that the internet has given us a platform able to move these long-form narratives from exploiting one class system to another; as the middle class expands and takes their 'devices' with them the internet and on-demand becomes the default cultural consumption device. 

3. Death of hyperfiction?

It would also be fair to say that we have moved on from the excitement of fragmented stories and open story systems that characterised early hyperfiction - these remain more interesting in their conception than their executions. Early hyperfiction authors have tended to drift one of three ways - they move to gaming, move towards conceptual art or back to print. Hyperfiction for it's own sake is mostly an obscure hobby now.

Despite the once apparently liberating principle of the hyperlink people like stories that are told to them, both narrative and investigative, and are even more willing to invest long periods of time in good ones. The difference between the 'when will this end?' of reading hyperfiction and the 'I don't want this to end' of complex 'told' narrative is significant and, I think, terminal in the case of hyperfiction.

What has shifted is that people 'do' stories in two ways - assembled by others (Stranger Things) but we are also prepared to assemble our own chains of meaning and interest by following loosely related ('recommended') content in what might be called hyperpersonal stories. This secondary form of self-directed story making is more akin to analysis in the classic mode - writing outselves with stories we make from fragments. Once this was undertaken with dreams, now the deep pool of alternative content that is the internet is a great substitute. This is writing as self-definition under the sign of the mystery - we like to solve ourselves, looking in the past, sifting truth and memory to create a story that fits our belief in ourselves that we then project to the world. We could call this activity #memeself, or more simply as Facebook.

That this #memeself is increasingly self reinforcing is also appratent. Personalisation and graph are used by the majors to reinforce existing personal views and prejudices. Seeing more content that affirms our world view is, at the least, contrary to democracy and at worst we have seen social-bubble effects hijacked by political parties to 'galvanise' mass movements. 
